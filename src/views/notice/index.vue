    ...
    <el-card shadow="never" class="border-0">
        <div class="f-between mb-4">
            <div class="flex justify-start">
                ...
                <el-button class="px-8 py-4 bg-green-500 text-light-50 rounded-full" v-permission="['sys:notice:import']" @click="importNotice">
                导入
                </el-button>
                <el-button class="px-8 py-4 bg-indigo-500 text-light-50 rounded-full" v-permission="['sys:notice:export']" @click="exportNotice">
                导出
                </el-button>
                <input type="text"
                v-model="title"
        ...
        <el-table :data="tableData" stripe v-loading="loading" class="w-full">
            ...
            <el-table-column align="center" :label="操作" width="200" v-permission="['sys:notice:update']">
                <template #default="scope">
                    <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-permission="['sys:notice:update']">修改</el-button>
                    <el-popconfirm title="是否要删除该公告?" confirmButtonText="确认" cancelButtonText="取消"
                        confirmButtonType="primary" cancelButtonType="text" @confirm="handleDelete(scope.row.id)">
                        <template #reference><el-button size="small" type="success" v-permission="['sys:notice:delete']">删除</el-button></template>
                    </el-popconfirm>
